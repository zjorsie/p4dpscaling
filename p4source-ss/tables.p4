...
table plus_total_table_packetCounter2 {
    reads {
    }
    actions {
        plus_total_packetCounter;
...
table plus_migration_table_ingress {
    reads {
    }
    actions {
        plus_migration;
...
table send_ss_mirror_to_cpu_tbl {
    reads {

    }
    actions {
        send_ss_mirror_to_cpu;
    }
}
...
table apply_packetCounter_stateful_ss_tbl {
    reads {
        flowID.flowID: exact;
    }
    actions {
